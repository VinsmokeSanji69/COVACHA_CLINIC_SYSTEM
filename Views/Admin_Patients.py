...
"")
        ...
        self.SortOrderBox = QtWidgets.QComboBox(self.Buttons)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SortOrderBox.sizePolicy().hasHeightForWidth())
        ...
        self.SortOrderBox.addItem("")
        self.SortOrderBox.addItem("")
        self.horizontalLayout.addWidget(self.SortOrderBox)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.SortByBox.setItemText(0, _translate("Form", "Ingrown"))
        self.SortByBox.setItemText(1, _translate("Form", "Kabag"))
        self.SortByBox.setItemText(2, _translate("Form", "Panuhot"))
        self.SortOrderBox.setItemText(0, _translate("Form", "Date Diagnosed"))
        self.SortOrderBox.setItemText(1, _translate("Form", "Gender"))
        self.SortOrderBox.setItemText(2, _translate("Form", "Name (Aphabetical)"))
