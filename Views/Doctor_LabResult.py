...
"")
        ...
        self.verticalLayout.addWidget(self.InterfaceTitle, 0, QtCore.Qt.AlignTop)
...
"}")
        ...
        self.PatID = QtWidgets.QLabel(self.PatInfo)
...
"")
        ...
        self.widget = QtWidgets.QWidget(self.Header_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 963, 192))
...
"")
        ...
        self.ViewLabResult = QtWidgets.QPushButton(self.widget_2)
        ...
        self.widget_3 = QtWidgets.QWidget(self.LabReq)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 963, 236))
...
"")
        ...
        self.AddPres = QtWidgets.QPushButton(self.widget_4)
        self.AddPres.setObjectName("AddPres")
        self.verticalLayout_12.addWidget(self.AddPres)
        self.EditPres = QtWidgets.QPushButton(self.widget_4)
        self.EditPres.setObjectName("EditPres")
        self.verticalLayout_12.addWidget(self.EditPres, 0, QtCore.Qt.AlignTop)
        self.DeletePress = QtWidgets.QPushButton(self.widget_4)
        self.DeletePress.setObjectName("DeletePress")
        self.verticalLayout_12.addWidget(self.DeletePress)
        self.horizontalLayout_9.addWidget(self.widget_4, 0, QtCore.Qt.AlignTop)
        ...
        self.Button.setStyleSheet("#DiagnoseButton {\n"
"    background-color: #2e6e65;\n"
"    font-size: 20px;\n"
"     padding: 10px 20px;\n"
"    text-align: center;\n"
"}")
        ...
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.Button)
        self.verticalLayout_15.setContentsMargins(0, 0, 20, 0)
        ...
        self.verticalLayout_15.addWidget(self.DiagnoseButton, 0, QtCore.Qt.AlignRight)
        self.verticalLayout_2.addWidget(self.Button, 0, QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.InterfaceTitle.setText(_translate("MainWindow", "Diagnosis"))
        self.Label.setText(_translate("MainWindow", "Patient ID"))
        self.PatID.setText(_translate("MainWindow", "100000"))
        ...
        self.PatDoB.setText(_translate("MainWindow", "Jan. 18, 2005"))
        ...
        self.AddPres.setText(_translate("MainWindow", "Add"))
        self.EditPres.setText(_translate("MainWindow", "Edit"))
        self.DeletePress.setText(_translate("MainWindow", "Delete"))
