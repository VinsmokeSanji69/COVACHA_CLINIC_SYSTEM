...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.Specialty.setItemText(0, _translate("Form", "Gynecologist"))
        self.Specialty.setItemText(1, _translate("Form", "Pediatrician"))
        self.Specialty.setItemText(2, _translate("Form", "Opthalmologist"))
        self.AddUserButton.setText(_translate("Form", "Add User"))
        self.label.setText(_translate("Form", "Doctors"))
        item = self.DoctorTable.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Doctor ID"))
        item = self.DoctorTable.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Name"))
        item = self.DoctorTable.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Specialty"))
        self.ViewDoctor.setText(_translate("Form", "View"))
        self.ModifyDoctor.setText(_translate("Form", "Modify"))
        self.DeleteDoctor.setText(_translate("Form", "Delete"))
        self.label_2.setText(_translate("Form", "Staff"))
        item = self.StaffTable.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Staff ID"))
