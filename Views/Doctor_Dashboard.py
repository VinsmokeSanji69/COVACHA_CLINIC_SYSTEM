...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.TotalPatientOverview.sizePolicy().hasHeightForWidth())
        self.TotalPatientOverview.setSizePolicy(sizePolicy)
        self.TotalPatientOverview.setMinimumSize(QtCore.QSize(0, 0))
        self.TotalPatientOverview.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"}")
        ...
        self.TotalPatient = QtWidgets.QLabel(self.frame_2)
        ...
        self.horizontalLayout_7.addWidget(self.TotalPatient)
        self.pushButton_7 = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_7.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/chart-no-axes-combined(green).svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/file-plus-2.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.AcceptCheckUp.setIcon(icon8)
...
"")
        ...
        self.DoctorSidePanel.setStyleSheet("#User {\n"
"    qproperty-alignment: \'AlignCenter\';\n"
"}")
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.TotalPatient.setText(_translate("Form", "000"))
        self.TotalDescription.setText(_translate("Form", "00 more than yesterday"))
        ...
        self.User.setText(_translate("Form", "Jayson Gabriel L. Limosnero"))
        self.UserSpecialty.setText(_translate("Form", "Cardiologist"))
        self.RecentText.setText(_translate("Form", "Recent"))
