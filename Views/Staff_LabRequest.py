...
"}")
        ...
        self.Specialty.setStyleSheet("QComboBox::down-arrow {\n"
...
"")
        ...
        self.Specialty.addItem("")
        self.Specialty.addItem("")
        self.horizontalLayout_4.addWidget(self.Specialty)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 740, 560))
