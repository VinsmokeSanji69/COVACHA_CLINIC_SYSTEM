...
# Form implementation generated from reading ui file 'Admin_AddDoctorCharges.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(16777215, 420))
        MainWindow.setBaseSize(QtCore.QSize(700, 420))
...
"")
        ...
        self.DocID = QtWidgets.QLineEdit(self.JoinedDate)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DocID.sizePolicy().hasHeightForWidth())
        self.DocID.setSizePolicy(sizePolicy)
        self.DocID.setMinimumSize(QtCore.QSize(250, 35))
        self.DocID.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.DocID.setFont(font)
        self.DocID.setObjectName("DocID")
        self.verticalLayout_4.addWidget(self.DocID, 0, QtCore.Qt.AlignLeft)
        ...
        self.DocName = QtWidgets.QLineEdit(self.widget_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DocName.sizePolicy().hasHeightForWidth())
        self.DocName.setSizePolicy(sizePolicy)
        self.DocName.setMinimumSize(QtCore.QSize(0, 35))
        self.DocName.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.DocName.setFont(font)
        self.DocName.setObjectName("DocName")
        self.verticalLayout_17.addWidget(self.DocName)
        ...
        self.Specialty = QtWidgets.QLineEdit(self.widget_10)
        self.Specialty.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Specialty.setFont(font)
        ...
        self.JoinedDate_2 = QtWidgets.QWidget(self.Body)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.JoinedDate_2.sizePolicy().hasHeightForWidth())
        self.JoinedDate_2.setSizePolicy(sizePolicy)
        self.JoinedDate_2.setMinimumSize(QtCore.QSize(0, 0))
        self.JoinedDate_2.setObjectName("JoinedDate_2")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.JoinedDate_2)
        self.verticalLayout_5.setContentsMargins(10, 0, 0, 0)
        self.verticalLayout_5.setSpacing(1)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.label_2 = QtWidgets.QLabel(self.JoinedDate_2)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_5.addWidget(self.label_2)
        self.DocRate = QtWidgets.QLineEdit(self.JoinedDate_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.DocRate.sizePolicy().hasHeightForWidth())
        self.DocRate.setSizePolicy(sizePolicy)
        self.DocRate.setMinimumSize(QtCore.QSize(250, 35))
        self.DocRate.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.DocRate.setFont(font)
        self.DocRate.setObjectName("DocRate")
        self.verticalLayout_5.addWidget(self.DocRate, 0, QtCore.Qt.AlignLeft)
        self.verticalLayout_3.addWidget(self.JoinedDate_2)
...
"}")
        ...
        self.ModifyCharges = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ModifyCharges.sizePolicy().hasHeightForWidth())
        self.ModifyCharges.setSizePolicy(sizePolicy)
        self.ModifyCharges.setMinimumSize(QtCore.QSize(200, 45))
        self.ModifyCharges.setMaximumSize(QtCore.QSize(200, 45))
        self.ModifyCharges.setStyleSheet("QPushButton {\n"
"    font: 900 10pt \"Satoshi Black\";\n"
"    background-color:  #2E6E65;\n"
"    border-radius: 10px;\n"
"    font-weight: bold;\n"
...
"    text-align: center;\n"
"}")
        self.ModifyCharges.setObjectName("ModifyCharges")
        self.horizontalLayout_2.addWidget(self.ModifyCharges)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Subheader.setText(_translate("MainWindow", "Modify Doctor Charges"))
        self.label.setText(_translate("MainWindow", "Doctor ID"))
        ...
        self.label_2.setText(_translate("MainWindow", "Doctor Rate"))
        self.Cancel.setText(_translate("MainWindow", "Cancel"))
        self.ModifyCharges.setText(_translate("MainWindow", "Modify Charges"))
