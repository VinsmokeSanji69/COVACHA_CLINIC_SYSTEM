...
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QCheckBox, QMessageBox, QLabel, QDialog, QDialogButtonBox, \
    QApplication
...
class DoctorLabResult(QMainWindow):
    def __init__(self, checkup_id=None, parent=None, refresh_callback=None):
        ...
        self.ui.AddPres.clicked.connect(self.open_add_prescription_form)
